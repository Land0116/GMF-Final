...
void GameOverState::s_restartPlay()
{
	TheGame::Instance()->getStateMachine()->changeState
	(PlayState::Instance());
	TheGame::Instance()->m_clickPowerLevel = 0;
	TheGame::Instance()->m_gameMoney = 0;
...
bool GameOverState::onEnter()
{
	...
	GameObject* gameOverText = new AnimatedGraphic(
		new LoaderParams(200, 100, 190, 30, "gameovertext"), 100);
	...
	std::cout << "PauseSate 재생" << std::endl;
	return true;
}
...
bool GameOverState::onExit()
{
	...
	TheTextureManager::Instance()
		->clearFromTextureMap("gamecleartext");
	TheTextureManager::Instance()
		->clearFromTextureMap("mainButton");
	TheTextureManager::Instance()
		->clearFromTextureMap("restart");
	std::cout << "PauseState 나가기" << std::endl;
